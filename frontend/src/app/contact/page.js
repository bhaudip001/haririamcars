    ...
    <div className="bg-[#f4f4f8] dark:bg-[#05050A] min-h-screen pt-20 pb-16 selection:bg-purple-500/30 relative overflow-clip transition-colors duration-500 flex flex-col w-full">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h1 className="font-['Outfit'] font-extrabold text-[42px] sm:text-[54px] md:text-[68px] text-black dark:text-white leading-[1.05] tracking-tight md:tracking-tighter mb-6 transition-colors">
