    ...
    <header className={`relative flex flex-col h-[480px] sm:h-[550px] md:h-auto md:min-h-[85vh] md:flex-row md:items-center font-['Inter',sans-serif] bg-[#050508] overflow-visible ${isMobileSearchOpen ? 'z-50' : 'z-20'}`}>
        ...
        <div className="absolute inset-x-0 top-[10%] z-10 px-6 flex flex-col items-start text-left">
          ...
          >
            Your <span className="relative inline-block font-bold">
              <span className="absolute left-0 top-0 text-white [-webkit-text-stroke:4px_white] drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]" aria-hidden="true">Dream Car,</span>
      ...
      >
        <div className="max-w-3xl text-left flex flex-col items-start">
          ...
          >
            Your <span className="relative inline-block font-bold">
              <span className="absolute left-0 top-0 text-white [-webkit-text-stroke:6px_white] drop-shadow-[0_6px_16px_rgba(0,0,0,0.6)]" aria-hidden="true">Dream Car,</span>
