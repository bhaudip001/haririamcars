...
export default function LiveTicker() {
  ...
  return (
    ...
    <div className="w-full py-4 sm:py-6 px-4 sm:px-6 lg:px-8 relative z-20">
      <div className="relative group max-w-6xl mx-auto">
        {/* Multi-tone ambient backlight aura matching Showroom Video */}
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/30 via-pink-500/20 to-indigo-600/30 rounded-[24px] sm:rounded-[30px] blur-xl opacity-60 dark:opacity-75 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />

        <div className="relative flex w-full h-[70px] sm:h-[84px] bg-[#0a0a12] overflow-hidden items-stretch rounded-2xl sm:rounded-3xl border border-gray-200/80 dark:border-white/15 shadow-2xl shadow-purple-950/20 dark:shadow-black/70 shimmer-effect">
